    ...
    return (
        <header className="bg-[url(./assets/images/headerbg.webp)] bg-cover bg-center w-full min-h-[730px] sm:min-h-[850px] relative overflow-hidden -top-[100px]">
            <div className='grid grid-cols-1 sm:grid-cols-2 container max-w-[1040px] z-[3] mt-[140px] sm:mt-[178px] relative gap-5'>
                ...
                <h1 className='font-Lucky text-[100px] sm:text-[120px] md:text-[150px] lg:text-[175.64px] font-normal leading-[106.13px] sm:leading-[126.13px] md:leading-[146.13px] lg:leading-[166.13px]  ml-3 sm:ml-6 flex flex-col text-center uppercase drop-shadow-[0px_6px_0px_#000000]'><span><span className='text-[#FBA11D] '>D</span><span className=' text-[#23AAAC]'>i</span><span className=' text-[#D45B07]'>n</span><span className='text-[#8EC627]'>o</span></span><span><span className='text-[#8EC627]'>L</span><span className='text-[#FCCA2B]'>F</span><span className=' text-[#8F78D2]'>G</span></span></h1>
            </div>
