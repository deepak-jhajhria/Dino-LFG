...
const AboutSec = () => {
    return (
        <div className='bg-[#09655A] -mt-28 relative z-[3]'>
            <div className='container mx-auto xl:max-w-[1157px] px-3 xl:px-6 relative z-20 pt-8 sm:pt-20 lg:pt-[91px] pb-6'>
            ...
            <img src={panda} alt="BabyDragon" className='lg:max-w-[169px] mini-dino max-w-[60px] w-full absolute right-0 lg:bottom-[-18%] bottom-[-4%] z-10' />
        </div>
    )
}
